...
"language_label" => "Idioma por defeito (public user)",
"language_text" => "For public (not logged in) users the language set for the browser user interface will be used for the calendar as well. If the browser language is not a valid calendar language, this default language will be used.<br>Note: Os ficheiros ui-{idioma}.php, ai-{idioma}.php, ug-{idioma}.php e ug-layout.png devem estar presentes na pasta lang/. {idioma} = selecionar o idioma da interface. Os nomes dos ficheiros tem de ser em minúsculas!",
...
<p>Exemplo do ficheiro CSV (extensão .cvs) pode ser encontrado na pasta '!luxcal-toolbox/' 
...
LuxCal Calendar.</p>
<p>O conteúdo do ficheiro vão ao encontro das [<u><a href='https://tools.ietf.org/html/rfc5545' 
...
<p>Exemplo de um ficheiro iCalendar (extensão .ics) pode ser encontrado na pasta '!luxcal-toolbox/' 
do calendário LuxCal.</p>
