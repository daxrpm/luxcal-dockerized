...
"vws_prev_year" => "Previous year",
"vws_next_year" => "Next year",
...
<li>An asterisk (*) in the search text will match any number of characters.<br>E.g.: 'de*r' matches 'December', 'dear', 'developer'.</li>
</ul>
