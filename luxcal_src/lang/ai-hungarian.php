...
"cat_duration" => "Event duration<br>! = fixed",
...
"cup_del_usr_text" => "Account of users not logged in since",
"cup_del_evt_text" => "Events which occurred before",
"cup_del_att_text" => "Attachments not used in events since",
"cup_del_rec_text" => "Recipients lists not used in events since",
"cup_del_tns_text" => "Thumbnails not used in events since",
...
<p>Sample CSV files can be found in the '!luxcal-toolbox/' directory of your LuxCal download.</p>
...
<p>Sample iCalendar files can be found in the '!luxcal-toolbox/' directory of your LuxCal 
download.</p>
