...
"language_label" => "Standard språk (public user)",
"language_text" => "For public (not logged in) users the language set for the browser user interface will be used for the calendar as well. If the browser language is not a valid calendar language, this default language will be used.<br>Note: Filerne ui-{språk}.php, ai-{språk}.php, ug-{språk}.php og ug-layout.png skal finnes i lang/ folderen. {språg} = det valgte språk til brukerinterfacen. Filnavne skal skrives med sm&aring; bokstaver!",
...
<p>Eksempel CSV-filer findes i folderen '!luxcal-toolbox/' i din LuxCal-download.</p>
...
<p>Eksempel iCalendar-filer kan findes i folderen '!luxcal-toolbox/' i din LuxCal 
download.</p>
...
be overwritten by the new file.</p>
<p>iCal filbeskrivelsen (f.eks. 'M&oslash;der 2024') er optional. Hvis det indtastes, 
