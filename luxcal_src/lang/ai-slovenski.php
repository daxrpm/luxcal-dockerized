...
"language_label" => "Privzeti jezik uporabniškega vmesnika (public user)",
"language_text" => "For public (not logged in) users the language set for the browser user interface will be used for the calendar as well. If the browser language is not a valid calendar language, this default language will be used.<br>Note: Datoteke ui-{language}.php, ai-{language}.php, ug-{language}.php in ug-layout.png morajo biti prisotne v lang/ mapi. {language} = izbran jezik uporabniškega vmesnika. Imena datotek morajo biti zapisane z malimi črkami!",
...
"restLastSel_text" => "Seja zadnjega uporabnika (plošča nastavitev možnosti) bo shranjena in ko se uporabnik kaasneje vrne k koledarju, bodo nastavitve povrnjene. If the user does not log in during the specified number of days, the values will be lost.",
"answer" => "answer",
"exp_days" => "days",
"view" => "pogled",
...
"dwTimeSlot_text" => "Časovni interval in višina za okno časa v pogledu dan/teden.<br>Ta vrednost bo skupaj z začetno uro in knočno uro (poglej navzgor) določala število vrstic v pogledu dan/teden.",
"dwTsInterval" => "Časovni interval",
"dwTsHeight" => "Višina",
...
"dateFormat_text" => "Besedilni niz, ki definira format datumov dogodkov v pogledih koledarja in vbosnih poljih.<br>Možne črke: y = leto, m = mesec in d = dan.<br>Ne-alfanumerični znaki so lahko uporabljeni kot ločilniki in bodo kopirani dobesedno.<br>Primeri:<br>y-m-d: 2024-10-31<br>m.d.y: 10.31.2024<br>d/m/y: 31/10/2024",
"dateFormat_expl" => "Npr.: y.m.d: 2024.10.31",
...
"MdyFormat_text" => "Besedilni niz ki definira format datumov ki so sestavljeni z dnevom, mesecom in letom.<br>Možne črke: d = dan v številkah, M = mesec v tekstu, y = leto v številkah.<br>Ne-alfanumerični znaki so lahko uporabljeni kot ločilniki in bodo kopirani dobesedno.<br>Primeri:<br>d M y: 12 April 2024<br>M d, y: Julij 8, 2024",
"MdyFormat_expl" => "Npr. M d, y: Julij 8, 2024",
"MyFormat_label" => "Format datuma (mesec yyyy)",
"MyFormat_text" => "Besedilni niz ki definira format datumov ki so sestavljeni z mesecom in letom.<br>Možne črke: M = mesec v tekstu, y = leto v številkah.<br>Ne-alfanumerični znaki so lahko uporabljeni kot ločilniki in bodo kopirani dobesedno<br>Primeri:<br>M y: April 2024<br>y - M: 2024 - Julij",
"MyFormat_expl" => "Npr. M y: April 2024",
...
"maxNoLogin_label" => "Max. number of days not logged in",
...
"mdb_purge_done" => "Events deleted more than 30 days ago permanently purged from the database",
...
<p>Sample CSV files (file extension .csv) can be found in the '!luxcal-toolbox/' directory 
